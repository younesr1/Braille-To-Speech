...
space = Letter(np.array([[0, 0], [0, 0], [0, 0]]), " ")
undefined = Letter(np.array([[0, 1], [0, 0], [0, 1]]), "")
period = Letter(np.array([[0, 0], [1, 1], [0, 1]]), ".")
comma = Letter(np.array([[0, 0], [1, 0], [0, 0]]), ",")

listOfLetters = [a, b, c, d, e, f, g, h, i, j, k, l,
                 m, n, o, p, q, r, s, t, u, v, w, x, y, z, space, undefined, period, comma]
